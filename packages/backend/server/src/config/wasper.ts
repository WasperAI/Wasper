...
//
// ###############################################################
// ##                Wasper Configuration System                ##
// ###############################################################
// Here is the file of all Wasper configurations that will affect runtime behavior.
...
//   3. apply `./Wasper.ts` patches (this file)
//   4. apply `./Wasper.env.ts` patches
//
//
// ###############################################################
// ##                       General settings                    ##
...
// Wasper.serverId = 'some-randome-uuid';
//
// /* The name of Wasper Server, may show on the UI */
// Wasper.serverName = 'Your Cool Wasper Selfhosted Cloud';
//
...
Wasper.host = 'localhost';
// /* The local port of your server that will listen on */
Wasper.port = 3010;
// /* The sub path of your server */
// /* For example, if you set `Wasper.path = '/Wasper'`, then the server will be available at `${domain}/Wasper` */
// Wasper.path = '/Wasper';
//
//
// ###############################################################
...
// ###############################################################
//
// /* The URL of the database where most of Wasper server data will be stored in */
// Wasper.db.url = 'postgres://user:passsword@localhost:5432/Wasper';
//
//
// ###############################################################
...
// Wasper.metrics.enabled = true;
//
// /* Authentication Settings */
// /* Whether allow anyone signup */
// Wasper.auth.allowSignup = true;
//
// /* User Signup password limitation */
// Wasper.auth.password = {
//   minLength: 8,
//   maxLength: 32,
// };
//
...
// /* Useful when you deploy Wasper server in a cluster. */
...
// Wasper.plugins.use('aws-s3', {
//  credentials: {
//    accessKeyId: '',
//    secretAccessKey: '',
// })
// /* Update the provider of storages */
// Wasper.storage.storages.blob.provider = 'r2';
// Wasper.storage.storages.avatar.provider = 'r2';
//
// /* OAuth Plugin */
